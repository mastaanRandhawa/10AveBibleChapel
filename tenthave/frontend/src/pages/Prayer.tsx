...
// View Prayer Requests Section - directs to Members area
const ViewPrayerRequestsSection: React.FC = () => {
  return (
    <div className="prayer-view-section">
      <div className="section-header">
        <h2>VIEW PRAYER REQUESTS</h2>
        <p>View and pray for our community's prayer needs</p>
      </div>
      <p className="prayer-view-message">
        Prayer requests are private and only available to church members. To
        view and pray for community prayer requests, please visit the Members
        area.
      </p>
      <Link to="/members" className="prayer-login-btn">
        Go to Members Area
      </Link>
    </div>
  );
      ...
      <div className="prayer-page-wrapper">
        ...
        <div className="prayer-content">
          ...
          <ScrollReveal className="prayer-form-section">
            ...
            <PrayerRequestForm onLoginClick={() => {}} />
          </ScrollReveal>

          {/* View Prayer Requests Section - directs to Members area */}
          <ScrollReveal>
            <ViewPrayerRequestsSection />
          </ScrollReveal>
        </div>
      </div>
    </PageContainer>
