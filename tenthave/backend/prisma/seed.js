...
async function main() {
    ...
    const memberPassword = await bcryptjs_1.default.hash("member123", 12);
    ...
    const services = [
        {
            ...
            description: "Join us for our weekly breaking of bread service where we remember the Lord's death and resurrection.",
            icon: "/assets/prayingiconround.svg",
            type: client_1.ServiceType.WEEKLY,
            isActive: true,
            order: 1,
            dayOfWeek: "Sunday",
            startTime: "9:30 AM",
            endTime: "10:30 AM",
            zoomLink: "https://us02web.zoom.us/j/6042227777?pwd=R2tDVy92NGlsWVkyb1BEendaRllPQT09",
        },
        {
    ...
    const ministries = [
        {
            ...
            description: "Weekly kids club, Sundays from 11:30 am to 12:30 pm, for children ages 8 through 14.",
    ...
    const aboutSections = [
      ...
      `,
            ...
            order: 1,
            slug: "who-we-are",
            metaDescription: "Learn about 10th Avenue Bible Chapel and our mission to share the love of Christ with our community.",
        },
        {
      ...
      `,
            ...
            metaDescription: "Discover the core beliefs and doctrines of 10th Avenue Bible Chapel based on biblical truth.",
        },
    ];
    ...
    await prisma.contactInfo.upsert({
        ...
        create: {
            ...
            additionalInfo: "We welcome visitors to all our services. Please feel free to contact us with any questions.",
        },
    });
    ...
    const sermonSeries = [
        {
            ...
            description: "A series exploring how God's plan is bigger than our individual stories",
            image: "/assets/crosss-mountain.png",
            isActive: true,
            order: 1,
            slug: "bigger-than-us",
            metaDescription: "Discover how God's plan is bigger than our individual stories in this inspiring sermon series.",
        },
        {
            ...
            metaDescription: "Learn about building healthy relationships and community in this practical sermon series.",
        },
        {
            title: "Romans",
            ...
            order: 3,
            slug: "romans",
            metaDescription: "Join us for a comprehensive study of the book of Romans and its timeless truths.",
        },
    ];
        ...
        const sermons = [
            {
                ...
                metaDescription: "Discover the hope we have in Christ for the future in this inspiring message.",
            },
            {
                ...
                metaDescription: "Learn how to live a life that reflects God's greater story.",
            },
        ];
    ...
    const prayerRequests = [
        {
            ...
            description: "Please pray for my grandmother who is recovering from surgery. We trust in God's healing power.",
            requester: "Sarah Johnson",
            category: client_1.PrayerCategory.HEALTH,
            priority: client_1.PrayerPriority.HIGH,
            status: client_1.PrayerStatus.APPROVED,
            isPrivate: false,
            userId: memberUser.id,
        },
        {
            title: "Family Unity",
            description: "Our family is going through a difficult time. Please pray for unity and peace in our home.",
            requester: "Anonymous",
            category: client_1.PrayerCategory.FAMILY,
            priority: client_1.PrayerPriority.NORMAL,
            status: client_1.PrayerStatus.APPROVED,
            isPrivate: false,
        },
        {
            ...
            requester: "Mike Chen",
            category: client_1.PrayerCategory.WORK,
            priority: client_1.PrayerPriority.NORMAL,
            status: client_1.PrayerStatus.PENDING,
            isPrivate: false,
        },
        {
            title: "Spiritual Growth",
            description: "Pray for my spiritual growth and deeper relationship with God.",
            requester: "Anonymous",
            category: client_1.PrayerCategory.SPIRITUAL,
            priority: client_1.PrayerPriority.NORMAL,
            status: client_1.PrayerStatus.APPROVED,
            isPrivate: true,
        },
    ...
    const siteConfigs = [
        ...
        {
            key: "john_3_16_verse",
            value: "FOR GOD SO LOVED THE WORLD THAT HE GAVE HIS ONLY BEGOTTEN SON, THAT WHOEVER BELIEVES IN HIM SHOULD NOT PERISH BUT HAVE EVERLASTING LIFE.",
