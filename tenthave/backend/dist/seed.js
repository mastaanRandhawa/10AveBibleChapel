...
async function main() {
    ...
    const announcements = await Promise.all([
        prisma.announcement.create({
            data: {
                ...
                content: "We're excited to announce the launch of our new church website and member portal. You can now access sermons, events, and submit prayer requests online.",
                category: "general",
                priority: "high",
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Join us for our annual mission trip to Guatemala from February 15-22, 2024. We'll be working with local communities to build homes and share the Gospel. Sign up at the church office.",
                category: "missions",
                priority: "high",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Join us for a 12-week study on the Book of Romans. Wednesdays at 7:00 PM in the Fellowship Hall. All are welcome!",
                category: "ministry",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Our sanctuary will be closed for maintenance on February 1st. Services will be held in the fellowship hall that day.",
                category: "general",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Join us for our special Easter Sunday service on March 31st at 10:00 AM. We'll have a special message, music, and a community breakfast following the service. All are welcome!",
                category: "worship",
                priority: "high",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Ladies, mark your calendars for our annual Spring Retreat on April 12-14 at the Mountain View Retreat Center. Registration opens March 1st. Contact Sarah Johnson for more information.",
                category: "ministry",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Join us for our monthly Men's Breakfast on the first Saturday of each month at 8:00 AM in the Fellowship Hall. Great food, fellowship, and Bible study. No registration required.",
                category: "ministry",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Registration for our Children's Sunday School program is now open! Classes available for ages 3-12. Please register your children at the welcome desk or online. Classes begin January 14th.",
                category: "ministry",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "We're collecting non-perishable food items for our local food pantry. Drop off donations in the collection bins in the lobby. Most needed items: canned goods, pasta, rice, and cereal. Thank you for your generosity!",
                category: "outreach",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Join us for our weekly prayer meeting every Tuesday at 7:00 PM in the Prayer Room. We pray for our church, community, and world. All are welcome to join us in prayer.",
                category: "ministry",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Registration is now open for our annual Youth Summer Camp, July 15-20. Open to students entering 6th-12th grade. Early bird pricing available until May 1st. Contact Pastor Mike for details.",
                category: "youth",
                priority: "high",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Interested in becoming a member? Join us for our New Member Orientation on the first Sunday of each month at 9:00 AM. Learn about our church history, beliefs, and how to get involved.",
                category: "general",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Join us for our beautiful Christmas Eve Candlelight Service on December 24th at 7:00 PM. Special music, message, and candlelight ceremony. Childcare provided for ages 0-3.",
                category: "worship",
                priority: "high",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "We want to thank all our amazing volunteers! Join us for a special appreciation dinner on March 15th at 6:00 PM. Please RSVP by March 8th. Your service to our church family is deeply appreciated.",
                category: "general",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: "Thank you for your faithful giving! We're pleased to share that we've reached 85% of our annual budget goal. Your generosity enables us to serve our community and support missions worldwide.",
                category: "general",
                priority: "normal",
                status: client_1.ContentStatus.PUBLISHED,
                isPublic: true,
    ...
    const events = await Promise.all([
        ...
        prisma.calendarEvent.create({
            data: {
                ...
                startDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 19, 0),
                endDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 20, 30),
                isAllDay: false,
        ...
        prisma.calendarEvent.create({
            data: {
                ...
                startDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 5, 18, 30),
                endDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 5, 20, 30),
                isAllDay: false,
                location: "Youth Room",
                category: "youth",
                color: "#F59E0B",
        ...
        prisma.calendarEvent.create({
            data: {
                ...
                description: "Weekly prayer meeting for church, community, and missions",
                startDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 18, 30),
                endDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 19, 30),
                isAllDay: false,
        ...
        prisma.calendarEvent.create({
            data: {
                ...
                startDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 6, 8, 0),
                endDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 6, 10, 0),
                isAllDay: false,
    ...
    const sermons = await Promise.all(sermonData.map((sermon) => prisma.sermon.create({
        data: {
            title: sermon.title,
            ...
            status: client_1.ContentStatus.PUBLISHED,
            isPublic: true,
            isFeatured: sermon.title.includes("BEST IS YET TO COME") ||
    ...
    const prayerRequests = await Promise.all([
        prisma.prayerRequest.create({
            data: {
                ...
                description: "Please pray for Sarah who is undergoing surgery next week. Pray for successful surgery and quick recovery.",
        ...
        prisma.prayerRequest.create({
            data: {
                ...
                description: "Pray for our mission team traveling to Guatemala. Pray for safety, health, and open hearts in the communities we serve.",
        ...
        prisma.prayerRequest.create({
            data: {
                ...
                description: "Seeking prayers for guidance and favor as I search for new employment opportunities.",
                requester: "Anonymous",
                isPrivate: false,
                isAnswered: false,
            },
        ...
        prisma.prayerRequest.create({
            data: {
                ...
                description: "Pray for healing and restoration in a family experiencing conflict.",
                requester: null,
                isPrivate: true,
                isAnswered: false,
            },
        ...
        prisma.prayerRequest.create({
            data: {
                ...
                description: "Please pray for our church family to grow deeper in faith and love for God and one another.",
        ...
        prisma.prayerRequest.create({
            data: {
                title: "New Baby",
                description: "Thank you for your prayers! Our baby was born healthy. Praise God!",
